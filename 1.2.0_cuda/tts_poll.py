...
if __name__ == '__main__':
    ...
    parser.add_argument('--sentence_silence', type=float, help='The number of seconds of silence after each sentence', required=False, default=0.0)
    ...
    try:
        ...
        synth_args = tts_args(speaker_id=parsed.speaker_id, length_scale=parsed.length_scale,
                              ...
                              sentence_silence=parsed.sentence_silence)
